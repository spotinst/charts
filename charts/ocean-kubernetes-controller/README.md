...
![Version: 0.1.75-beta.1](https://img.shields.io/badge/Version-0.1.75--beta.1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 2.3.0](https://img.shields.io/badge/AppVersion-2.3.0-informational?style=flat-square)
...
| image.tag | string | `"ih-sod-8135-1-fix-controller-vulnerabilities@sha256:6e7485133271ff3a3c80b4265fdcbf857fcf4da0435c922a9c1bf657b1d57796"` | Overrides the image tag whose default is the chart appVersion. |
