...
![Version: 0.1.72-beta.1](https://img.shields.io/badge/Version-0.1.72--beta.1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 2.1.2](https://img.shields.io/badge/AppVersion-2.1.2-informational?style=flat-square)
...
| image.tag | string | `"feat-spotcon-36789-improve-pdb-handling"` | Overrides the image tag whose default is the chart appVersion. |
